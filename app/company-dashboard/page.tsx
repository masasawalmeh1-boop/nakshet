    ...
    try {
      ...
      if (chatData.success) {
        ...
        if (chatData.conversations.length > 0) {
          setSelectedConversationId((prev: number | null) =>
            prev ?? chatData.conversations[0].id
          );
        }
      }
    } catch (error) {
    ...
    <div className={styles.page}>
      <aside className={styles.sidebar}>
        ...
        <div className={styles.sidebarCard}>
          <h4>Quick Notes</h4>
          <p>
            Upload final designs, keep revision notes clear, and use chat for direct client feedback.
          </p>
        </div>
      </aside>
      ...
      <main className={styles.main}>
        <header className={styles.topbar}>
          <div>
            ...
            <p>
              Manage projects, upload designs and videos, and chat with the system team in one place.
            </p>
          </div>
              ...
              <>
                <section className={styles.statsGrid}>
                  <div className={styles.statCard}>
                    <div className={styles.statIcon}><FolderOpen size={18} /></div>
                    <div>
                      <h3>{totalProjects}</h3>
                  ...
                  <div className={styles.statCard}>
                    <div className={styles.statIcon}><Upload size={18} /></div>
                    <div>
                      <h3>{totalUploads}</h3>
                      <p>Total Uploads</p>
                    </div>
                  ...
                  <div className={styles.statCard}>
                    <div className={styles.statIcon}><ImageIcon size={18} /></div>
                    <div>
                      <h3>{designCount}</h3>
                      <p>Design Files</p>
                    </div>
                  ...
                  <div className={styles.statCard}>
                    <div className={styles.statIcon}><Video size={18} /></div>
                    <div>
                      <h3>{videoCount}</h3>
                      <p>Video Files</p>
                    </div>
                  ...
                  {projects.map((project) => (
                    <div key={project.id} className={styles.projectCard}>
                      ...
                      <div className={styles.projectMeta}>
                        <span><Clock3 size={14} /> Ongoing work</span>
                        <span><CheckCircle2 size={14} /> {project.uploads.length} files</span>
                      </div>
                    </div>
                  ))}
                </div>
